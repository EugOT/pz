...
`ANTHROPIC_API_KEY`, `OPENAI_API_KEY`, `GOOGLE_API_KEY`, `GEMINI_API_KEY`, `GOOGLE_APPLICATION_CREDENTIALS`, `VERTEX_API_KEY`, `VERTEX_PROJECT`, `VERTEX_LOCATION`, `PZ_API_KEY`, `PZ_AUTH_TOKEN`, `AWS_SECRET_ACCESS_KEY`, `AWS_SESSION_TOKEN`, `GITHUB_TOKEN`, `GH_TOKEN`, `GITLAB_TOKEN`, `NPM_TOKEN`, `DOCKER_AUTH_CONFIG`, `KUBECONFIG`, `SSH_AUTH_SOCK`.
